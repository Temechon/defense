...
var FireEffect = (function (_Effect) {
    _inherits(FireEffect, _Effect);

    function FireEffect(scene) {
        _classCallCheck(this, FireEffect);

        _get(Object.getPrototypeOf(FireEffect.prototype), 'constructor', this).call(this, scene);

        // fire material
        var mat = scene.getMaterialByName('_fireEffectMaterial_');
        if (!mat) {
...
//# sourceMappingURL=FireEffect.js.map
